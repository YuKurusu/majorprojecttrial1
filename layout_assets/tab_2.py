...
tab_2_layout = html.Div(
    [
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.Button(
                            'Click me for recommendations.', id='Button')
        ...
        html.Div(id='Recommendation_content'
...
# Recommendation Content Layout

# Heading for recommendation results
recommendation_content_layout = html.Div(
                ...
                html.Div(
                    [
                        dcc.Loading(
                            id="loading-1",
                            type="default",
                            children=html.Div(id='datatable', style={
                                              'fontWeight': 'bold'})
                        ),
                    ],
                ),
...
@app.callback(
    Output('Recommendation_content', component_property='children'),
...
def render_content(Button):
    if Button == None:
        ...
        return recommendation_content_layout
...
def callback_recommendation_results(Button, Recommendation_Methods, Games):
    ...
    if (Recommendation_Methods == 'KNN') & (Button != None):
        ...
        for x in results:
            tmp = df[df['name'] == x][[
                'name', 'developer', 'genre', 'theme', 'image_url']]
